...
//        Gonderilen dropdown elemention tum optionslari alinir
    ...
    public void selectFromDropdown(){
        selectFromDropdown(driver.findElement(By.xpath("//select[@id='year']")), "1998");//1998 i secti
        selectFromDropdown(driver.findElement(By.id("month")),"August");
        selectFromDropdown(driver.findElement(By.id("day")),"01") ;
    }
}