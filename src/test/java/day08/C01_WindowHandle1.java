...
public class C01_WindowHandle1 extends TestBase{
    ...
    //2-      ILK SAYFANIN IDSINI ALALIM
        String window1Handle = driver.getWindowHandle();

    //3-  Sayfadaki textin “Opening a new window” olduğunu doğrulayın.
        String window1Text = driver.findElement(By.xpath("//h3")).getText();   //bir tane h3 oldugunu icin bunu alabiliriz. .tagNae de "h3" kullanilir
